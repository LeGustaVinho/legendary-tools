...
namespace LegendaryTools
{
    ...
    public static class LocalizationManager
    {
        ...
        {
            FileReader reader = new FileReader(asset);
        ...
        {
            FileReader reader = new FileReader(bytes);
        ...
        static void BroadCastToRootCanvas()
        {
            BaseLocalize[] allBaseLocalize = UnityEngine.Object.FindObjectsOfType<BaseLocalize>();

            foreach (BaseLocalize baseLocalize in allBaseLocalize)
                baseLocalize.OnLocalize();
        }
