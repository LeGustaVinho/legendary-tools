...
namespace LegendaryTools
{
    ...
    public class FileReader
    {
        ...
        public FileReader(byte[] bytes) { mBuffer = bytes; }
        public FileReader(TextAsset asset) { mBuffer = asset.bytes; }

        /// <summary>
        /// Read the contents of the specified file and return a Byte Reader to work with.
        /// </summary>

        static public FileReader Open(string path)
        {
