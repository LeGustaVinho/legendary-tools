...
{   
    public static class Localization
    {
        ...
        {
            get { return PlayerPrefs.GetString(CURRENT_LANGUAGE, Languages.Length > 0 ? Languages[0] : string.Empty); }
            set
            {
        ...
        public static Dictionary<string, Dictionary<string, string>> LocalizationData = new Dictionary<string, Dictionary<string, string>>();
        ...
        public static string GetAndFormat(string key, params string[] args)
        {
            ...
            if (string.IsNullOrEmpty(localized)) return string.Empty;
